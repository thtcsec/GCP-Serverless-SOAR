...
class GCPIsolationWorker:
    ...
    def _validate_instance(self, instance_name, zone, operation_id):
        ...
        try:
            ...
            self._log_step(operation_id, 'validate_instance', 'success', f"Instance {instance_name} validated (state: {state})")
    ...
    def _create_isolation_firewall(self, instance_name, zone, operation_id):
        ...
        try:
            ...
            operation = compute_client.insert_firewall(
                project=PROJECT_ID,
    ...
    def _apply_isolation_tag(self, instance_name, zone, operation_id):
        ...
        try:
            ...
            self._log_step(operation_id, 'apply_isolation_tag', 'success', f"Applied isolation tag to instance {instance_name}")
