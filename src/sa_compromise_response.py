...
def calculate_sa_risk_score(payload):
    ...
    high_risk_methods = ["CreateServiceAccountKey", "SetIamPolicy", "UndeleteServiceAccountKey"]
...
def remove_critical_roles(sa_email):
    ...
    try:
        ...
        for binding in policy.bindings:
            if binding.role in critical_roles and member_to_remove in binding.members:  # noqa: SIM102
...
def send_sa_alert(sa_email, principal_email, risk_data, payload, approved=True, intel_report=None):
    ...
    try:
        ...
        alert = {
            ...
            "approved": approved,
            "intel_summary": {"vt_malicious": risk_data.get("breakdown", {}).get("vt_malicious") if risk_data else 0},
        }
